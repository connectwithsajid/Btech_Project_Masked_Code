...
var firebaseConfig = {
  ...
  storageBucket: "####Masked####",
  messagingSenderId: "####Masked####",
  appId: "####Masked####",
  measurementId: "####Masked####", // google analytics
};
...
function folUsr(id) {
  ...
  var mpToken =
    "pk.####Masked####.R2nh61HBc6YfuLxTHO6SPw";
